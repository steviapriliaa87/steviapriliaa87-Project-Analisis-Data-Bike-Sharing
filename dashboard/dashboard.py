...
st.title("\U0001F6B2 Dashboard Penyewaan Sepeda")
...
# Visualisasi Penyewaan Berdasarkan Bulan
...
# Visualisasi Perbandingan Penyewa Registered vs Casual
...
# Visualisasi Tren Penyewaan Sepeda Berdasarkan Tahun
...
fig = px.line(monthly_trend, x="month", y="total_rentals", color="year", markers=True, labels={"month": "Bulan", "total_rentals": "Total Penyewaan", "year": "Tahun"})
st.plotly_chart(fig)
